...
@XmlSeeAlso({
    GetChapterResponse.class,
    UpdateSlideResponse.class,
    GetTopicResponse.class,
    DeleteCourseResponse.class,
    UpdateTopicResponse.class,
    GetCourseInfoResponse.class,
    CreateSlideResponse.class,
    CreateChapterResponse.class,
    DeleteChapterResponse.class,
    DeleteTopicResponse.class,
    DeleteSlideResponse.class,
    CreateTopicResponse.class,
    CreateNewCourseResponse.class,
    UpdateCourseResponse.class,
    GetSlideResponse.class,
    UpdateChapterResponse.class,
