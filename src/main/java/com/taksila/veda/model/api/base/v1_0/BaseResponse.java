...
@XmlSeeAlso({
    GetEnrollmentResponse.class,
    CreateEnrollmentResponse.class,
    DeleteClassroomResponse.class,
    UpdateClassroomResponse.class,
    GetClassroomResponse.class,
    UpdateEnrollmentResponse.class,
    DeleteEnrollmentResponse.class,
    CreateClassroomResponse.class,
