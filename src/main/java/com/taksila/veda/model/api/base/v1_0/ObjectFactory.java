...
public class ObjectFactory {
    ...
    private final static QName _BaseResponseSuccess_QNAME = new QName("http://www.taksila.com/veda/model/api/base/v1_0", "success");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.taksila.com/veda/model/api/base/v1_0", name = "success", scope = BaseResponse.class, defaultValue = "false")
    public JAXBElement<Boolean> createBaseResponseSuccess(Boolean value) {
        return new JAXBElement<Boolean>(_BaseResponseSuccess_QNAME, Boolean.class, BaseResponse.class, value);
    }
