...
public class ObjectFactory {
    ...
    private final static QName _ContactAddress_QNAME = new QName("http://www.taksila.com/veda/model/db/usermgmt/v1_0", "address");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.taksila.com/veda/model/db/usermgmt/v1_0", name = "address", scope = Contact.class)
    public JAXBElement<Address> createContactAddress(Address value) {
        return new JAXBElement<Address>(_ContactAddress_QNAME, Address.class, Contact.class, value);
    }
